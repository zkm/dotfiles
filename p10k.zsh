# Generated by Powerlevel10k configuration wizard on 2025-03-12 at 20:56 CDT.
...
() {
  ...
  # Cohesive dark-cyan palette to match kitty and Plasma without rewriting prompt structure.
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND=67
  ...
  typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND=17
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=179
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND=17
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=116
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_FOREGROUND=255
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND=124
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND=17
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND=110
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_FOREGROUND=17
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_BACKGROUND=110
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=17
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND=109
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_FOREGROUND=17
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_BACKGROUND=74
  typeset -g POWERLEVEL9K_VI_MODE_FOREGROUND=255
  typeset -g POWERLEVEL9K_VI_MODE_NORMAL_BACKGROUND=29
  typeset -g POWERLEVEL9K_VI_MODE_INSERT_BACKGROUND=24
  typeset -g POWERLEVEL9K_VI_MODE_VISUAL_BACKGROUND=60
  typeset -g POWERLEVEL9K_VI_MODE_OVERWRITE_BACKGROUND=130
