...
function testAutoFormat(docUri, expectedFormatted) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const actualFormatted = (yield vscode_1.default.commands.executeCommand('vscode.executeFormatDocumentProvider', docUri, {
            insertSpaces: true,
            tabSize: 2,
        }));
        ...
        assert_1.default.strictEqual(actualResult, expectedFormatted);
    });
}
suite('Should format', () => {
    const docUri = (0, helper_1.getDocUri)('format/schema.prisma');
    const docUriExpected = (0, helper_1.getDocUri)('format/expected.prisma');
    const textDocument = fs_1.default.readFileSync(docUriExpected.fsPath, 'utf8');
    test('Diagnoses format', function () {
        return __awaiter(this, void 0, void 0, function* () {
